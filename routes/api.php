...
use App\Http\Controllers\Api\SPA\SpaOrderController;
...
Route::group([
    ...
    Route::post('order', [SpaOrderController::class, 'order']);
});
...
Route::group([
    ...
    Route::post('payments', [ApiUserController::class, 'postPaymentMethods']);
    Route::post('payment-methods', [ApiUserController::class, 'getPaymentMethods']);
    Route::post('remove-payment', [ApiUserController::class, 'removePaymentMethod']);
    Route::post('payments', [ApiUserController::class, 'postPaymentMethods']);
});
...
Route::group([
    ...
    Route::post('setup-intent', [ApiUserController::class, 'getSetupIntent']);
});
