            ...
            <tr v-for="item in products" :key="item.id">
                ...
                <td>
                    ...
                    >
                        ...
                        Add <span class="ml-1" v-if="activeCartItem && activeCartItem.qty > 0">{{ activeCartItem.qty }}</span>
                    </button>
                </td>
            </tr>
        </table>
...
.size-select option:first-child {
...
size-select option:first-child:hover,
.size-select option:first-child:selected {
    font-weight: normal;
    background-color: transparent;
}
</style>
