...
import 'bootstrap';
import 'jquery-lazy';
import 'jquery-lazy/jquery.lazy.plugins.min';
...
import ShoppingCartLoginButtons from './components/ShoppingCartLoginButtons';
...
$(document).ready(function() {
    if($('#app').is(':visible')) {
        const app = new Vue({
            ...
            store,
            beforeCreate() {
//                store.commit('initStateByStorage', store.state.cart)
            },
            components: {
                Shop,
                Products,
