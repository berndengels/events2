...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('event_time'), 'has-success': fields.event_time && fields.event_time.valid }">
    ...
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <div class="input-group input-group--custom">
            ...
            <datetime v-model="form.event_time" :config="timePickerConfig" class="flatpickr" :class="{'form-control-danger': errors.has('event_time'), 'form-control-success': fields.event_time && fields.event_time.valid}" id="event_time" name="event_time" placeholder="{{ trans('brackets/admin-ui::admin.forms.select_a_time') }}"></datetime>
        </div>
...
@if(isset($eventPeriodic))
    @include('brackets/admin-ui::admin.includes.media-uploader', [
        'id'    => 'images',
        'name'  => 'images',
        'label' => 'Images',
        'mediaCollection' => app(App\Models\EventPeriodic::class)->getMediaCollection('images'),
        'media' => $eventPeriodic->getThumbs200ForCollection('images'),
    ])
@else
    @include('brackets/admin-ui::admin.includes.media-uploader', [
        'id'    => 'images',
